"""
Advanced HTTP Server with Performance Metrics
Author: Barak Gonen & Nir Dweck | Modified by: Eli Penso

Key Features:
- Headers: Added Date, Server, Connection, and X-Response-Time (ms).
- Logic: Supports /calculate-next and /calculate-area (Triangle) via GET.
- Storage: POST /upload for file saving and GET /image for retrieval.
- Security: Directory Traversal protection using path normalization.
- Testing: Built-in 'assertions' suite for automated logic verification.
"""
